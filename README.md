...
- legacy `signals` `backtests.py` / `strategies.py` paths now run through class-based compatibility adapters with structured deprecation logging, keeping old sync contracts while marking migration boundaries explicitly
