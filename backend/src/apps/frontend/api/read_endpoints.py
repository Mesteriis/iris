...
from src.apps.frontend.api.deps import FrontendReadDep
from src.apps.frontend.api.presenters import frontend_dashboard_snapshot_read, frontend_shell_snapshot_read
