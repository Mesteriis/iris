...
from src.apps.frontend.api.contracts import FrontendDashboardSnapshotRead, FrontendShellSnapshotRead
from src.apps.indicators.api.presenters import coin_metrics_read, market_cycle_read, market_flow_read, market_radar_read
from src.apps.market_data.api.presenters import coin_read
...
from src.apps.portfolio.api.presenters import portfolio_action_read, portfolio_position_read, portfolio_state_read
from src.apps.predictions.api.presenters import prediction_read
from src.apps.signals.api.presenters import (
...
from src.apps.system.api.presenters import system_status_read
