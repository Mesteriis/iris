...
from iris.core.http.matrix import write_http_availability_matrix
from iris.core.settings import get_settings


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Export the IRIS HTTP availability matrix across launch modes.")
...
def main() -> int:
    ...
    output_path = write_http_availability_matrix(settings=settings, output=args.output)
    print(output_path)
    return 0
