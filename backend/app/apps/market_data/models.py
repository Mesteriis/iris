...
if TYPE_CHECKING:
    ...
    from app.apps.indicators.models import CoinMetrics, FeatureSnapshot, IndicatorCache
    from app.apps.patterns.models import MarketCycle
    from app.apps.portfolio.models import PortfolioAction, PortfolioBalance, PortfolioPosition
    from app.apps.predictions.models import MarketPrediction, PredictionResult
    from app.apps.signals.models import FinalSignal, InvestmentDecision, MarketDecision, RiskMetric, Signal, SignalHistory
