...
from app.apps.market_data.repos import fetch_candle_points_between
from app.apps.market_data.domain import ensure_utc, utc_now
from app.apps.predictions.cache import cache_prediction_snapshot, cache_prediction_snapshot_async
