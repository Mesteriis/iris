...
from app.apps.portfolio.cache import cache_portfolio_balances, cache_portfolio_state
...
def _ensure_coin_for_balance(db: Session, *, symbol: str, exchange_name: str) -> Coin:
    from app.apps.market_data.service_layer import create_coin, get_coin_by_symbol
