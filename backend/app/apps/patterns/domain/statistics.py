...
from app.apps.patterns.domain.lifecycle import resolve_lifecycle_state
from app.apps.patterns.domain.registry import PATTERN_CATALOG, sync_pattern_metadata
from app.apps.patterns.domain.semantics import is_pattern_signal, slug_from_signal_type
