...
from app.apps.patterns.models import DiscoveredPattern
...
from app.apps.patterns.domain.narrative import build_sector_narratives
from app.apps.patterns.domain.regime import RegimeRead, compute_live_regimes, read_regime_details
