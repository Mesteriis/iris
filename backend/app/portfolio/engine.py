...
from app.exchanges import create_exchange_plugin
...
from app.services.portfolio_cache import cache_portfolio_balances, cache_portfolio_state
...
def _ensure_coin_for_balance(db: Session, *, symbol: str, exchange_name: str) -> Coin:
    from app.services.history_loader import create_coin, get_coin_by_symbol
