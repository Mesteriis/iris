...
from app.apps.patterns.domain.scheduler import get_activity_snapshot, mark_analysis_requested, should_request_analysis
...
from app.apps.patterns.cache import cache_regime_snapshot, read_cached_regime
