...
from app.apps.anomalies.consumers import CandleAnomalyConsumer, SectorAnomalyConsumer
from app.apps.cross_market.engine import process_cross_market_event
from app.apps.news.consumers import NewsCorrelationConsumer, NewsNormalizationConsumer
from app.apps.signals.fusion import evaluate_market_decision
from app.apps.signals.fusion import evaluate_news_fusion_event
from app.core.db.session import AsyncSessionLocal
from app.core.settings import get_settings
from app.runtime.streams.consumer import EventConsumer, EventConsumerConfig, default_consumer_name
from app.runtime.streams.publisher import publish_event
from app.runtime.streams.router import subscribed_event_types
...
from app.apps.patterns.domain.cycle import update_market_cycle
from app.apps.patterns.domain.decision import evaluate_investment_decision
...
from app.apps.patterns.domain.narrative import refresh_sector_metrics
from app.apps.patterns.domain.risk import evaluate_final_signal
from app.apps.patterns.domain.scheduler import should_request_analysis
from app.apps.portfolio.engine import evaluate_portfolio_action
from app.apps.indicators.analytics import process_indicator_event
from app.apps.indicators.snapshots import capture_feature_snapshot
from app.apps.patterns.cache import cache_regime_snapshot_async, read_cached_regime_async
from app.apps.signals.history import refresh_recent_signal_history
...
def _latest_indicator_value(db, *, coin_id: int, timeframe: int, indicator: str, timestamp: object) -> float | None:
    from app.apps.indicators.models import IndicatorCache
