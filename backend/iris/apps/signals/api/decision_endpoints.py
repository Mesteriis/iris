...
from iris.apps.signals.api.contracts import CoinDecisionRead, InvestmentDecisionRead
...
from iris.apps.signals.api.presenters import coin_decision_read, investment_decision_read
