...
from iris.apps.signals.api.contracts import CoinFinalSignalRead, FinalSignalRead
...
from iris.apps.signals.api.presenters import coin_final_signal_read, final_signal_read
