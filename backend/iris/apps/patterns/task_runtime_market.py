...
from iris.apps.patterns.domain.discovery import (
    DISCOVERY_HORIZON,
    DISCOVERY_STEP,
...
from iris.apps.patterns.domain.strategy import (
...
from iris.apps.signals.models import Signal, Strategy, StrategyPerformance, StrategyRule
