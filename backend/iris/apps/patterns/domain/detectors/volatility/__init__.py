...
from iris.apps.indicators.domain import atr_series, bollinger_bands
...
from iris.apps.patterns.domain.utils import average, clamp, closes, signal_timestamp, volume_ratio
