...
from iris.apps.patterns.domain.narrative import SectorNarrative
from iris.apps.patterns.domain.semantics import is_cluster_signal, is_hierarchy_signal, is_pattern_signal
