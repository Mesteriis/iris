...
from iris.apps.market_data.repositories import CandleRepository, CoinRepository
from iris.apps.patterns.cache import read_cached_regime_async
...
from iris.apps.patterns.domain.lifecycle import lifecycle_allows_detection
from iris.apps.patterns.domain.registry import PATTERN_CATALOG, SUPPORTED_PATTERN_FEATURES
from iris.apps.patterns.domain.success import GLOBAL_MARKET_REGIME, PatternSuccessSnapshot, normalize_market_regime
from iris.apps.patterns.models import DiscoveredPattern, PatternFeature, PatternRegistry, PatternStatistic
from iris.apps.patterns.query_services import PatternQueryService
from iris.apps.signals.models import Signal, SignalHistory, Strategy
...
class PatternTaskBase(PersistenceComponent):
    ...
    async def _strategy_alignment(
        ...
        *,
        ...
        from iris.apps.patterns.domain.decision import _clamp as decision_clamp
        from iris.apps.patterns.domain.strategy import MIN_DISCOVERY_SAMPLE
