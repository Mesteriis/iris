...
from iris.apps.patterns.domain.lifecycle import resolve_lifecycle_state
from iris.apps.patterns.domain.semantics import is_pattern_signal, slug_from_signal_type
from iris.apps.patterns.domain.statistics import (
...
from iris.apps.patterns.models import PatternRegistry
from iris.apps.signals.history_support import SIGNAL_HISTORY_LOOKBACK_DAYS
from iris.apps.signals.models import SignalHistory
from iris.apps.signals.services import SignalHistoryService
...
class PatternHistoryStatisticsMixin:
    ...
    async def _refresh_pattern_statistics(
        ...
        *,
        ...
        from iris.apps.patterns.domain.registry import PATTERN_CATALOG
