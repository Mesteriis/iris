...
from iris.apps.predictions.services import PredictionSideEffectDispatcher
from iris.apps.predictions.services.results import PredictionCreationBatch
...
class CrossMarketSideEffectDispatcher:
    async def apply(
        ...
        *,
        ...
        from iris.apps.cross_market import services as services_module
