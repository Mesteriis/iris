...
from iris.apps.control_plane.api.deps import AIOperatorQueryDep, AIPromptCommandDep, ControlActorDep
...
from iris.apps.hypothesis_engine.api.contracts import AIPromptCreate, AIPromptUpdate
from iris.apps.hypothesis_engine.api.errors import hypothesis_error_to_http
from iris.apps.hypothesis_engine.contracts import PromptMutationResult
