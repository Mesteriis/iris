...
from iris.apps.indicators.analysis_scheduler_service import AnalysisSchedulerService
...
from iris.apps.indicators.feature_snapshot_service import FeatureSnapshotService
...
from iris.apps.indicators.results import (
...
from iris.apps.indicators.service_support import (
...
from iris.apps.patterns.domain.regime import calculate_regime_map, primary_regime, serialize_regime_map
...
class IndicatorAnalyticsService:
    ...
    def _known_signal_types(self) -> set[str]:
        from iris.apps.indicators.analytics import SIGNAL_TYPES
