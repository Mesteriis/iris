...
from iris.apps.indicators.results import FeatureSnapshotCaptureResult
from iris.apps.market_data.domain import ensure_utc
from iris.apps.patterns.domain.regime import read_regime_details
from iris.apps.patterns.domain.semantics import is_cluster_signal, is_pattern_signal
