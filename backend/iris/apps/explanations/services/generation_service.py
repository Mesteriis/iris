...
from iris.apps.explanations.contracts import ExplainKind, ExplanationArtifactResult, ExplanationGenerationOutput
from iris.apps.explanations.language import resolve_requested_language
from iris.apps.explanations.prompts import EXPLAIN_OUTPUT_SCHEMA
from iris.apps.explanations.read_models import ExplanationContextBundle
from iris.apps.hypothesis_engine.prompts import LoadedPrompt
from iris.core.ai import (
    AICapability,
    AIExecutionRequest,
    AIExecutor,
...
from iris.core.i18n import MessageDescriptor, get_translation_service, normalize_language
