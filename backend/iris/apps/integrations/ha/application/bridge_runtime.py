...
from iris.apps.integrations.ha.application.control_state import HA_TIMEFRAME_OPTIONS, HAControlStateStore
from iris.apps.integrations.ha.errors import (
    HACommandDispatchError,
    HACommandNotAvailableError,
    HAInvalidPayloadError,
)
from iris.apps.integrations.ha.schemas import (
    HAAvailabilityRead,
    HABootstrapRead,
    HACapabilitiesRead,
    HACatalogRead,
...
from iris.core.ai import notification_humanization_runtime_enabled
from iris.core.db.session import AsyncSessionLocal
from iris.core.errors import PlatformError
from iris.core.http.errors import ApiErrorFactory
from iris.core.http.operation_localization import localize_operation_event, localize_operation_status
...
from iris.core.i18n import build_locale_policy, get_translation_service
...
class HABridgeFacade:
    ...
    async def operation_status(self, operation_id: str) -> HAOperationRead | None:
        ...
        if localized_status.error_code is not None and localized_status.error_message is not None:
            from iris.apps.integrations.ha.schemas import HAErrorRead
    ...
    def system_health_message(self) -> dict[str, Any]:
        from iris.apps.integrations.ha.schemas import HASystemHealthMessage
    ...
    def command_accepted_ack(self, *, request_id: str, operation_id: str) -> dict[str, Any]:
        from iris.apps.integrations.ha.schemas import HACommandAckMessage
    ...
    def command_error_ack(
        ...
        *,
        ...
        from iris.apps.integrations.ha.schemas import HACommandAckMessage, HAErrorRead
