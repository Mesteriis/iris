...
from iris.apps.news.api.contracts import NewsItemRead, NewsPluginRead, NewsSourceRead
from iris.apps.news.api.deps import NewsQueryDep
from iris.apps.news.api.presenters import news_item_read, news_plugin_read, news_source_read
