...
from iris.api.router import build_router as build_api_router
from iris.core.http.launch_modes import resolve_deployment_profile, resolve_launch_mode
from iris.core.http.router_policy import generate_operation_id
...
def create_app() -> FastAPI:
    ...
    async def deferred_lifespan(app: FastAPI) -> AsyncIterator[None]:
        from iris.core.bootstrap.lifespan import lifespan
