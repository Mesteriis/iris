...
from iris.apps.anomalies.consumers import CandleAnomalyConsumer, SectorAnomalyConsumer
...
from iris.apps.hypothesis_engine.consumers import HypothesisConsumer
from iris.apps.indicators.results import IndicatorEventResult
from iris.apps.indicators.services import AnalysisSchedulerService, FeatureSnapshotService, IndicatorAnalyticsService
from iris.apps.news.consumers import NewsCorrelationConsumer, NewsNormalizationConsumer
from iris.apps.notifications.consumers import NotificationConsumer
from iris.apps.patterns.cache import cache_regime_snapshot_async, read_cached_regime_async
from iris.apps.patterns.runtime_results import PatternRegimeRefreshResult
from iris.apps.portfolio.services import PortfolioService, PortfolioSideEffectDispatcher
from iris.apps.signals.services import SignalFusionService, SignalFusionSideEffectDispatcher, SignalHistoryService
from iris.apps.signals.services.results import SignalFusionBatchResult, SignalFusionResult
from iris.core.db.uow import AsyncUnitOfWork, BaseAsyncUnitOfWork
...
if TYPE_CHECKING:
    from iris.apps.patterns.task_services import PatternRealtimeService, PatternSignalContextService
...
def _pattern_realtime_service_factory(uow: BaseAsyncUnitOfWork) -> PatternRealtimeService:
    from iris.apps.patterns.task_services import PatternRealtimeService
