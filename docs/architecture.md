...
- sync compatibility entrypoints in `apps/signals/backtests.py`, `apps/signals/strategies.py`, `apps/signals/fusion.py` and `apps/signals/history.py` now run through class-based compatibility adapters/services with structured deprecation logs
