...
> Historical rollout tracker.
> This work is complete and preserved only for implementation history.
> Current guidance lives under `docs/architecture/` and the active delivery documents.
