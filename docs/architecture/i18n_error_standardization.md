...
- kept ADR draft `docs/architecture/adr/0016-error-taxonomy-and-boundary-localization.md` only as historical rollout background, not as active source of truth.
