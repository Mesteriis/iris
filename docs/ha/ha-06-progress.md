...
>
> This document is operational tracking only.
> Normative source of truth remains:
> - `ha-02-protocol-spec.md`
> - `adr-0001-ha-integration-architecture.md`
> - `ha-03-backend-plan.md`
> - `ha-04-hacs-integration-plan.md`
> - `ha-05-tasks.md`
